...
const Myeducation = () => {
  return (
        ...
        <div className='bg-[#161616] h-[550px] w-[100%]'>
         <div className="bg-[#161616] shadow-xl h-[120px] w-[90%] ml-[50px] mt-[30px] flex gap-4" >
                ...
                <div className=" ">
                <h1 className="text-white  text-[30px] ">School Education</h1>
            ...
            <div className="bg-[#161616] shadow-xl h-[120px] w-[90%] ml-[50px] mt-[50px] flex gap-4" >
